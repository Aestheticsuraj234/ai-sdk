...
export default function TranscribeAudioPage() {
  ...
  /**
   * Handles the form submission event, sending the selected audio file to the
   * server to be transcribed. If the request is successful, the transcript is
   * displayed and the selected file is cleared. If the request fails, an error
